...
export default class DB {
    ...
    constructor(url) {
      ...
      ApproveRequest = async (json) => {
        ...
        try {
            ...
            var response = await fetch("http://localhost:55317/ApproveRequest",
     ...
     GenerateBills = async () => {
        ...
        try {
            ...
            console.log(this.url)
            var response = await fetch("http://localhost:55317/GenerateBills",
    ...
    MonthlyConsumption = async () => {
        ...
        try {
            ...
            console.log(this.url)
            var response = await fetch("http://localhost:55317/MonthlyConsumption?billId=" + 7,
    ...
    allServiceForUser = async (action) => {
        ...
        try {
            ...
            //var response = await fetch("http://localhost:55317/api/allRequestTypesOfStaff");
            var response = await fetch("http://localhost:55317/api/services/allServiceForUser",
    ...
    findAllRequestsForUser = async (action) => {
        ...
        try {
            ...
            //var response = await fetch("http://localhost:55317/api/allRequestTypesOfStaff");
            var response = await fetch("http://localhost:55317/api/service/allRequestTypesOfStaff",
