    ...
    return (
      <div>
        ...
        <Tabs tabType={'scrollable-buttons'}>
          ...
          {
            this.handleLoggedInConsumerStaff() == 2 &&
            <Tab style={styles.headline} containerElement={<Link to="/PaymentBill" />} value="pane-2" label="Payment"></Tab>
          }
          {
            this.handleLoggedInConsumerStaff() == 2 &&
            <Tab style={styles.headline} containerElement={<Link to="/TicketsList" />} value="pane-2" label="All Tickets"></Tab>
          }
