...
const db = new DB("http://localhost:55317/api/accounts")
...
export default class Register extends Component {
    ...
    register = async (json, action) => {
        ...
        try {
            var response = await fetch('http://localhost:55317/api/Account/Register',
    ...
    findOne = async (Id, action) => {
        ...
        try {
            var response = await fetch('http://localhost:55317/api/accounts/' + Id);
                        ...
                        <div className="center">
                            <div className="form">
                                ...
                                <div >
                                    ...
                                    <br />
                                    Password: <MUI.TextField value={this.state.password} onChange={this.handlePassword} floatingLabelText="Password" />
                                    <br />
                                    <br />
                                    <br />
                                    <MUI.RaisedButton label="lodsfdfdssfgin" onClick={this.handleLogin} primary={true} />
                                    <br />
                                    <br />
                                </div>
                            </div>
                    ...
                    <Tab style={styles.headline} label="REGISTER" value="b">
                        <div className="center">
                            <div className="form">
                                ...
                                <br />
                                Passowrd: <MUI.TextField value={this.state.password} onChange={this.handlePassword} floatingLabelText="Enter your password" />
                                <br />
                                Confirm Password: <MUI.TextField value={this.state.confirmpassword} onChange={this.handleConfirmPassword} floatingLabelText="Enter your password again" />
                                <br />
