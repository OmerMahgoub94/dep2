...
const RFS_DB = new DB("http://localhost:55317/api/services/RFS");
const DFS_DB = new DB("http://localhost:55317/api/services/DFS");
const servicesDB = new DB("http://localhost:55317/api/services");
